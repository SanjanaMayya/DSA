...
print(f"\nTime Complexity:")
print(f"Best case: O(1) - Element at first position")
print(f"Average case: O(n/2) ≈ O(n) - Element in middle")
print(f"Worst case: O(n) - Element at last position or not found")